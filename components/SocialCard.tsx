...
export default function SocialCard() {
  return (
    <div data-spotlight-card className="bg-card transition-colors duration-200 delay-75 overflow-hidden md:col-span-3 lg:col-span-1 flex flex-col w-full h-full">
