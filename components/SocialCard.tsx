...
export default function SocialCard() {
  return (
    ...
    >
      ...
      <div className="border-l border-transparent md:border-accent/20 pl-0 md:pl-7 flex flex-col gap-9 py-1">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-3 sm:gap-4 mt-2">
            ...
            <a
              ...
              aria-label="GitHub"
              className="w-9 h-9 sm:w-11 sm:h-11 rounded-md sm:rounded-lg border border-accent/20 bg-white dark:bg-zinc-950 flex items-center justify-center text-foreground hover:text-accent hover:border-accent hover:bg-accent/5 hover:scale-105 transition-all duration-300 shadow-sm"
            >
        ...
        <div className="flex flex-col gap-4 mt-6">
          ...
          <div className="flex items-center gap-4 sm:gap-6 mt-2">
            <span className="text-[32px] sm:text-[40px] font-black text-[#048379] dark:text-[#14b8a6] tracking-tight leading-none select-none">
              CV
            </span>
            <a
              href="/Resume.pdf"
              target="_blank"
              className="flex items-center gap-1.5 sm:gap-2 px-4 py-2 sm:px-5 sm:py-2.5 rounded-lg border border-accent/25 bg-white dark:bg-zinc-950 text-accent hover:bg-accent/5 hover:border-accent hover:scale-[1.03] transition-all duration-300 text-[11px] sm:text-xs md:text-sm font-bold shadow-sm"
            >
              <span>Download</span>
              <svg
                viewBox="0 0 24 24"
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="inline-block w-3 h-3 sm:w-3.5 sm:h-3.5"
              >
